...
// * version:1.0.0
// * des: 继承TextView的文本阅读视图
// */
//public class ReadingView extends TextView {
...
//
//    public ReadingView(Context context, AttributeSet set) {
//        super(context, set);
//        TypedArray typedArray = context.obtainStyledAttributes(set, R.styleable.ReadingTextView);
//        int width = typedArray.getInt(R.styleable.ReadingTextView_textwidth, 320);
//        float textsize = typedArray.getDimension(R.styleable.ReadingTextView_textSize, 24);
//        int textcolor = typedArray.getColor(R.styleable.ReadingTextView_textColor, -1442840576);
//        float linespace = typedArray.getDimension(R.styleable.ReadingTextView_lineSpacingExtra, 15);
//        int typeface = typedArray.getColor(R.styleable.ReadingTextView_typeface, 0);
//
//        typedArray.recycle();
//
...
//    }
//
//    public void SetText(String text)//注：此函数目前只有在UI线程中调用才可以把文本画出来，在其它线程中无法画文本，找了好久找不到原因，求高手解答)
//    {
//        string = text;
//        // requestLayout();
//        // invalidate();
